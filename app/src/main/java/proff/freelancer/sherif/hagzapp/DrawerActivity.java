...
import proff.freelancer.sherif.hagzapp.fragment.MainAppBarFragment;
...
public class DrawerActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        case R.id.nav_gallery:
           ...
           getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container,new MainAppBarFragment()).commit();
           break;
